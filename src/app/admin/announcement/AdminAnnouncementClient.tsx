...
export default function AdminAnnouncementClient({
  announcements,
  companies,
  outlets,
  ...
  const filteredOutlets = selectedCompanyId
    ? outlets.filter((o) => o.companyId === selectedCompanyId)
    : [];
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <p className="text-slate-500 mt-1 font-medium">
            Broadcast messages across companies with photos and staff acknowledgment tracking
          </p>
        </div>
        <button
                  ...
                  <div className="flex justify-between items-start mb-4">
                    <div className="space-y-1 flex-1">
                      ...
                      <div className="flex flex-wrap items-center gap-3">
                        ...
                        <span className="text-[10px] font-bold text-purple-600 bg-purple-50 dark:bg-purple-900/20 px-2 py-0.5 rounded-full uppercase tracking-widest flex items-center gap-1">
                          <Building2 size={10} />
                          {ann.company?.name || "—"}
                        </span>
                        {ann.outlet && (
          ...
          <div className="card-base p-6">
            ...
            <ul className="space-y-3">
              <li className="flex gap-2 text-[11px] text-slate-500 leading-relaxed">
                ...
                <span>Pick the right company — the message reaches only staff in that group.</span>
              </li>
              <li className="flex gap-2 text-[11px] text-slate-500 leading-relaxed">
                <ChevronRight size={14} className="text-blue-500 flex-shrink-0" />
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    className="block w-full px-4 py-3 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-sm focus:ring-2 focus:ring-blue-500/20 transition-all appearance-none cursor-pointer disabled:opacity-50"
                  >
